...
function shouldBehaveLikeKIP7 (errorPrefix, initialSupply, initialHolder, recipient, anotherAccount) {
  ...
  describe('transfer', function () {
    shouldBehaveLikeKIP7Transfer(errorPrefix, initialHolder, recipient, initialSupply,
  ...
  describe('approve', function () {
    shouldBehaveLikeKIP7Approve(errorPrefix, initialHolder, recipient, initialSupply,
...
function shouldBehaveLikeKIP7Transfer (errorPrefix, from, to, balance, transfer) {
  describe('when the recipient is not the zero address', function () {
...
function shouldBehaveLikeKIP7Approve (errorPrefix, owner, spender, supply, approve) {
