...
const KIP7PausableMock = artifacts.require('KIP7PausableMock');
const { shouldBehaveLikePublicRole } = require('../../behaviors/access/roles/PublicRole.behavior');
const shouldFail = require('../../helpers/shouldFail');

contract('KIP7Pausable', function ([_, pauser, otherPauser, recipient, anotherAccount, ...otherAccounts]) {
  const initialSupply = new BN(100);

  beforeEach(async function () {
    this.token = await KIP7PausableMock.new(pauser, initialSupply, { from: pauser });
  });
